...
var Address_detail =document.forms['vform'] ['Address_detail'];
...
Address_detail.addEventListener('blur',Address_detail,true);
// validation function
function Validate() {
  // validate username
  if (username.value == "") {
...
if (Address_detail.value == "") {
  username.style.border = "1px solid red";
  document.getElementById('Address_detail').style.color = "red";
  name_error.textContent = "Address is required";
  Address_detail.focus();
  return false;
}
// validate Address
if (Address_detail.value.length < 20) {
  Address_detail.style.border = "1px solid red";
  document.getElementById('Address_detail').style.color = "red";
  name_error.textContent = "please enter valid Adddress";
  Address_detail.focus();
  return false;
}
...
function passwordVerify() {
  ...
  function Address_detail() {
    if (Address_detail.value != "") {
     Address_detail.style.border = "1px solid #5e6e66";
     document.getElementById('username_div').style.color = "#5e6e66";
     name_error.innerHTML = "";
     return true;
    }
